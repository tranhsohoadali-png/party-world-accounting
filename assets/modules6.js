...
M.CATALOGS = {
  'cat-employees': {
    ...
    fields: [
      ...
      { k: 'salaryBase', l: 'Lương cơ bản / tháng (đ)', type: 'number' },
      { k: 'dayWage', l: 'Lương theo ngày công (đ/ngày) — nếu > 0 sẽ tính lương chính theo ngày công, thay cho Lương cơ bản/tháng', type: 'number' },
